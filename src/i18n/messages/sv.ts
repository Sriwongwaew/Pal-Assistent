...
export const sv: Catalogue = {
  ...
  "palette.glacier": "Glaciär",
  "palette.press": "Bladet",
  "palette.instrument": "Instrumentet",
  "language.aria": "Språk",
  ...
  "ptip.keeps": "Sparas: {why}",
  "ptip.fodder": "Inte på spara-listan — kondenseringskön kan mata den",
  "stip.owned.one": "{n} i boxen",
  "stip.owned.other": "{n} i boxen",
  "stip.best": "bästa {iv}",
  "stip.unobtainable": "GÅR INTE ATT FÅ TAG PÅ",
  "stip.sprint": "SPR",
  ...
  "box.filter.plan": "I planen",
  "box.sort.score": "Poäng",
  "box.sort.iv": "IV",
  "box.sort.combat": "Stridsstyrka",
  "box.sort.level": "Level",
  "box.sort.stars": "Stjärnor",
  "box.sort.species": "Art",
  "box.sort.ivFloor": "Svagaste IV-stat",
  "box.sort.pv": "Flest passiver",
  "box.sort.slot": "Var den står",
  "box.sort.by": "Sortera efter",
  "box.sort.then": "Sedan efter",
  "box.sort.none": "Inget",
  "box.sort.descShort": "högst först",
  "box.sort.ascShort": "lägst först",
  "box.search.clear": "Töm sökfältet",
  "box.sort.desc": "Högst först – klicka för lägst först",
  "box.sort.asc": "Lägst först – klicka för högst först",
  "box.plan.title": "Ingår i din avelsplan",
  "box.plan.carrier": "PLAN",
  "box.plan.step": "STEG {n}",
  ...
  "quest.j.worldtreeNote": "Världsträdet är en egen spelkarta — aldrig en gissad prick på den här. Det bor i faserna här, och på sin egen karta under Kartan.",
  ...
  "map.sub": "Spelets egna kartor med datamine-positioner — öarna och Världsträdet, som är en egen karta. Skrolla för zoom, dra för att panorera, klicka på en markör. Hittat-status kommer ur din save.",
  "map.alt": "Palworlds världskarta",
  "map.altTree": "Världsträdets karta",
  "map.pickMap": "Välj karta",
  "map.name.main": "Palpagosöarna",
  "map.name.tree": "Världsträdet",
  "map.l.towers": "Torn",
  ...
  "map.l.treeBosses": "Bossar",
  "map.l.eggs": "World Tree-ägg",
  "map.l.chests": "Kistor",
  "map.l.paloxite": "Paloxite",
  "map.l.fishing": "Fiskeplatser",
  "map.l.springs": "Teafant Springs",
  "map.l.journals": "Anteckningar",
  "map.l.junk": "Skrothögar",
  "map.treeMidBoss": "Mellanboss — saven räknar hur många av de tre som fallit, inte vilka",
  "map.chestName": "Kista",
  "map.fishingName": "Fiskeplats",
  "map.fishingRare": "Sällsynt fiskeplats",
  "map.junkName": "Skrothög",
  ...
  "map.ruinSub": "ger denna schematic, garanterat",
  ...
  "find.sub": "Ett sökfält över allt appen vet: arter, varor och var de kommer ifrån, passiver, partnerskills, legendariska schematics, platser på kartan, expeditioner, raider och fiskelistan – plus avelskombon om du skriver två arter med ett x emellan. Varje träff länkar dit man gör något åt den.",
  ...
  "find.combo.note": "Skriv två arter med ett x emellan. En legendar kan paras med vad som helst – det man inte kan är att få en legendar ur ägget om inte båda föräldrarna är den arten.",
  "find.cond.now": "GÖR DET NU",
  "find.cond.max": "FULLT KONDENSERAD",
  "find.cond.maxLine": "Redan 4★ — de {n} dubbletterna kan inte tillföra något här.",
  "find.cond.need": "{n} till för {star}★",
  "find.cond.feed": "Mata",
  "find.cond.feedN": "{n} av dina {of}",
  "find.cond.nothingYet": "Inget att mata än — {n} dubbletter till tar den till {star}★.",
  "find.cond.allKept": "Alla {n} står på spara-listan, så det finns inget att mata. Skälet står på var och en — hovra den.",
  "find.cond.allBooked": "{n} av dina {owned} är bokade av avelsplanen, och resten står på spara-listan — inget att mata.",
  "find.cond.noneOwned": "Inget att mata.",
  ...
  "find.how.ruin": "En fast plats som alltid har just den – ingen droppchans inblandad. Ancient Ruins är vaktade och ligger ofta obekvämt, så priset är resan dit och inte turen. Ta med något som flyger.",
  ...
  "find.schemRuin": "ANCIENT RUIN · GARANTERAD",
  ...
  "pp.cantBreedLead": "Detta par har inget barn i avelstabellen:",
  ...
  "manres.noChildBody":
    "{a} × {b} har inget barn i avelstabellen. Datasetet saknar avelsrang för en av dem, så det går inte att säga vad ägget skulle bli.",
  ...
  "pp.carrier": "BÄRARE",
  "pp.impossiblePair":
    "datasetet saknar avelsrang för {name}, så vi kan inte säga vad ägget skulle bli. Välj en annan bärare av passiven.",
  "pp.noChain":
  ...
  "cake.group": "Tårtan",
  "cake.forEggs": "för ≈{n} ägg — en per ägg (≈)",
  "cake.forEggsX": "för ≈{n} ägg — den lägger {x} åt gången, alltså hälften så många (≈)",
  "cake.why.passives": "Du jagar passiver, alltså {cake}: spelet säger att ungarna oftare ärver flera passiver från föräldrarna.",
  "cake.why.iv": "Du jagar IV, alltså {cake}: spelet säger att talangerna växer lättare och att mutationer blir vanligare.",
  "cake.why.volume": "Du behöver bara ägg, alltså {cake}: den lägger två åt gången, vilket är hälften så många tårtor för samma plan.",
  "cake.why.plain": "Inget särskilt att jaga här, alltså {cake} — den billigaste. De andra gör var sin extra sak; välj en så följer räkningen med.",
  "cake.oddsNow": "Som det är står din kläckare på {odds} per ägg; tårtan lyfter det med ett tal spelet aldrig anger.",
  "cake.ownNone": "äger ingen",
  "cake.ownAtBase": "äger {n} · {base} i en bas",
  "cake.ownStored": "äger {n}, ingen i en bas",
  "cake.note": "En tårta per ägg är uppmätt av communityt, inte utsagt av spelet — summorna är alltså lika ungefärliga som äggtalet de kommer ur. Spelet har fem tårtor; det här är den vanliga, den avelsfarmen brukar matas med.",
