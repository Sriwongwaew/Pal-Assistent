...
export const en = {
  ...
  "ptip.keeps": "Kept: {why}",
  "ptip.fodder": "Not on the keep list — the condense queue may feed it",
  "stip.owned.one": "{n} in your box",
  "stip.owned.other": "{n} in your box",
  "stip.best": "best {iv}",
  "stip.unobtainable": "CANNOT BE OBTAINED",
  "stip.sprint": "SPR",
  ...
  "box.sort.score": "Score",
  "box.sort.iv": "IV",
  "box.sort.combat": "Combat power",
  "box.sort.level": "Level",
  "box.sort.stars": "Condense stars",
  "box.sort.species": "Species",
  "box.sort.ivFloor": "Weakest IV stat",
  "box.sort.pv": "Most passives",
  "box.sort.slot": "Where it stands",
  "box.sort.by": "Sort by",
  "box.sort.then": "Then by",
  "box.sort.none": "Nothing",
  "box.sort.descShort": "highest first",
  "box.sort.ascShort": "lowest first",
  "box.search.clear": "Clear the search",
  ...
  "find.cond.now": "DO IT NOW",
  "find.cond.max": "FULLY CONDENSED",
  "find.cond.maxLine": "Already at 4★ — the {n} duplicates cannot add anything here.",
  "find.cond.need": "{n} more for {star}★",
  "find.cond.feed": "Feed",
  "find.cond.feedN": "{n} of your {of}",
  "find.cond.nothingYet": "Nothing to feed yet — {n} more duplicates take it to {star}★.",
  "find.cond.allKept": "All {n} are on the keep list, so there is nothing to feed. The reason is on each one — hover it.",
  "find.cond.allBooked": "{n} of your {owned} are reserved by the breeding plan, and the rest are on the keep list — nothing to feed.",
  "find.cond.noneOwned": "Nothing to feed.",
  ...
  "cake.group": "The cake",
  "cake.forEggs": "for ≈{n} eggs — one per egg (≈)",
  "cake.forEggsX": "for ≈{n} eggs — it lays {x} at once, so half as many (≈)",
  "cake.why.passives": "You are chasing passives, so {cake}: the game says pals are more likely to inherit several passive skills from their parents.",
  "cake.why.iv": "You are chasing IVs, so {cake}: the game says talents grow more easily, and mutations are more likely.",
  "cake.why.volume": "You only need eggs, so {cake}: it lays two at once, which is half the cakes for the same plan.",
  "cake.why.plain": "Nothing special to chase here, so {cake} — the cheapest one. The others each do something extra; pick one and the bill follows.",
  "cake.oddsNow": "As it stands your hatcher is {odds} per egg; the cake lifts that by an amount the game never states.",
  "cake.ownNone": "none owned",
  "cake.ownAtBase": "{n} owned · {base} at a base",
  "cake.ownStored": "{n} owned, none at a base",
  "cake.note": "One cake per egg is measured by the community, not stated by the game — the totals are as approximate as the egg count they come from. What each cake does is the game's own wording, and it never says by how much: hover a name to read it.",
