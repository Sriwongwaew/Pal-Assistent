...
export const en = {
  ...
  "quest.j.worldtreeNote": "The World Tree is its own in-game map — it lives in the phases here, never as a guessed dot.",
  ...
  "map.sub": "The game's own map with datamined positions. Scroll to zoom, drag to pan, click a marker. Found status comes from your save.",
  ...
  "find.linkCombat": "Your combat team →",
  "find.linkBest": "Find a pal for… →",
  ...
  "find.hero.strong": "Strong against",
  "find.hero.yourBest": "your best counter:",
  "find.hero.bestAgainst": "your best against {el}:",
  "find.hero.yourPals": "In your box",
  "find.hero.palsOfEl.one": "{n} pal",
  "find.hero.palsOfEl.other": "{n} pals",
  "find.hero.allOfEl": "All {el} species →",
  "find.hero.expedNeed": "Expeditions that count {el} pals",
  "find.hero.expedNeedN": "needs {n}",
  "find.hero.expedHave": "{have} idle of {need} needed",
  "find.hero.bestOfEl": "Your best {el} pal",
  "find.hero.noneOwned": "None in the box yet",
  ...
  "find.combo.note": "Type two species with an x between them. Legendaries only breed with their own species, so an empty answer is the game's rule, not a missing row.",
  ...
  "pp.cantBreedLead": "This pair cannot breed (legendaries only breed with their own species). Move the passive via an intermediary:",
